...
toa_init(void)
{
	 ...
	 */
//	myfunc mf = 0xffffffff810c4f90;
//	sk_data_ready_addr = mf("sock_def_readable");
//0xffffffff8145a610;//kallsyms_lookup_name("sock_def_readable");
//	sk_data_ready_addr = kallsyms_lookup_name("sock_def_readable");
	//sk_data_ready_addr =  0xffffffff8145a610; 
   	get_fn_addr(); 
